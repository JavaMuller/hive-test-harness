	SELECT
		...
		,bu.bu_ref 
		,bu.bu_group 
		,CASE WHEN FJ.source_type <> 'Activity'  THEN 'N/A for balances' ELSE src.source_group END 
		,CASE WHEN FJ.source_type <> 'Activity'  THEN 'N/A for balances' ELSE src.source_ref END 
		,CASE WHEN FJ.source_type <> 'Activity'  THEN 'N/A for balances' ELSE UL.preparer_ref END 
		,CASE WHEN FJ.source_type <> 'Activity'  THEN 'N/A for balances' ELSE UL.department END 
		,CASE WHEN FJ.source_type <> 'Activity'  THEN 'N/A for balances' ELSE AUL.department END 
		,CASE WHEN FJ.source_type <> 'Activity'  THEN 'N/A for balances' ELSE AUL.preparer_ref END  
