...
# Vagrantfile generated by https://github.com/timveil/hdp-vagrant-generator on 2/8/16 5:40 PM
...
yum install unzip git deltarpm -y -q
...
echo " "
echo "---------------------------------------------------------------------------------------------------------------"
echo "----- Getting Ambari YUM Repo from http://public-repo-1.hortonworks.com/ambari/centos7/2.x/updates/2.2.0.0/ambari.repo"
echo "---------------------------------------------------------------------------------------------------------------"
echo " "

wget -q http://public-repo-1.hortonworks.com/ambari/centos7/2.x/updates/2.2.0.0/ambari.repo -O /etc/yum.repos.d/ambari.repo
...
wget -q http://dev.mysql.com/get/Downloads/Connector-J/mysql-connector-java-5.1.38.zip -O /usr/share/java/mysql-connector-java-5.1.38.zip
cd /usr/share/java
...
ambari-server setup --jdbc-driver=/usr/share/java/mysql-connector-java-5.1.38/mysql-connector-java-5.1.38-bin.jar --jdbc-db=mysql
...
curl -s --show-error -H "X-Requested-By: ambari" -X POST -d '{"ViewInstanceInfo":{"instance_name":"FILES_VIEW_INSTANCE","label":"Files View","visible":true,"icon_path":"","icon64_path":"","properties":{"webhdfs.url":"webhdfs://hivetest.hdp.local:50070","webhdfs.username":null,"webhdfs.auth":"auth=SIMPLE"},"description":"Files View installed by https://github.com/timveil/hdp-vagrant-generator"}}' -u admin:admin http://hivetest.hdp.local:8080/api/v1/views/FILES/versions/1.0.0/instances/Files
...
curl -s --show-error -H "X-Requested-By: ambari" -X POST -d '{"blueprint" : "custom-generated-blueprint","default_password" : "password","host_groups" :[{"name" : "host_group_1","hosts" : [{"fqdn" : "hivetest.hdp.local"}]}]}' -u admin:admin http://hivetest.hdp.local:8080/api/v1/clusters/hivetest
